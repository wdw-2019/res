<?php 
     @$year = $_POST['year'];//post获取表单里的department
     
     include('connect.php');//链接数据库
     $sql = "select * from evaluate where date like '$year-%' ";
     $avg="select avg(grade) from evaluate where date like '$year-%' ";
    ...
    while($row=mysqli_fetch_row($result)){
     ...
     echo "<font color='red'>$a</font>";
        ...
        echo "<font color='red'>该年份无数据！</font>";
    }
?>